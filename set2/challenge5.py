...
from set2.challenge2 import encrypt_AES_ECB, decrypt_AES_ECB
...
def cut_and_paste_ECB(cipher):
    ...
    encryption_block_prefix = 'A' * email_padding_encryption + \
        email_beginning
    prefix_num_blocks = len(f'email={encryption_block_prefix}') // 16
    encryption_input = encryption_block_prefix + \
        block_to_encrypt.decode('utf-8')
