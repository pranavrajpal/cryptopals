from challenge43 import sha1_hash, get_dsa_constants, get_private_dsa_key_message_val, get_sha1_fingerprint
...
def repeated_nonce_find_private(messages):
    ...
    for message1, message2 in message_pairs:
        if message1['r'] == message2['r']:
            ...
            private = get_private_dsa_key_message_val(
                message1['m'], k, signature)
            return private
