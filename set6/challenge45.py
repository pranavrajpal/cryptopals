...
def dsa_substitute_g0():
    ...
    forged_correct = dsa_verify(
        b'Forged message', public, signature, constants)
...
def dsa_substitute_g1():
    ...
    original_correct = dsa_verify(
        message, public, original_signature, constants)
    modified_correct = dsa_verify(
        message2, public, original_signature, constants)
    ...
    message1_correct = dsa_verify(
        message, public, created_signature, constants)
    message2_correct = dsa_verify(
        message2, public, created_signature, constants)
